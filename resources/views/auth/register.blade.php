                ...
                <div class="boxese">
                    <div class="card-body">
                        <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
                            ...
                            <!-- Contact Number -->
                            <div class="mb-3 col-6">
                                <x-input-label for="number" :value="__('number')" class="form-label" />
                                <x-text-input id="number" class="form-control" type="text" name="number" :value="old('number')" required autocomplete="Contact Number" />
                                <x-input-error :messages="$errors->get('number')" class="text-danger mt-2" />
                            </div>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <div>
                                    ...
                                    <input type="radio" id="gender_male" class="text-light" name="gender" value="male" {{ old('gender') == 'male' ? 'checked' : '' }}>
                                    
                                    <label for="gender_female">Female</label>
                                    <input type="radio" id="gender_female" class="text-light" name="gender" value="female" {{ old('gender') == 'female' ? 'checked' : '' }}>
                                </div>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea id="address" class="form-control" type="text" name="address" :value="old('address')" required autocomplete="Employee Address"></textarea>
                            ...
                            <div class="mb-3">
                                ...
                                <x-text-input id="image" class="form-control" type="file" name="image" :value="old('image')" required autocomplete="Put a Image" />
                                <x-input-error :messages="$errors->get('image')" class="text-danger mt-2" />
                            </div>
                            ...
                            <div class="d-flex align-items-center justify-content-between mt-4">
                                ...
                                <x-primary-button class="btn btn-outline-primary ms-4">
                                    {{ __('Register') }}
                                </x-primary-button>
                            </div>
                        </form>
